...
class AsaasDriver implements GatewayDriver
{
    ...
    public function createCardPayment(
        ...
        if (! is_array($address) || empty($address['zip_code']) || ! isset($address['street_number'])) {
            $pool = [
                ['zip_code'=>'01310100','street_name'=>'Avenida Paulista','street_number'=>'1000','neighborhood'=>'Bela Vista','city'=>'Sao Paulo','federal_unit'=>'SP'],
                ['zip_code'=>'04543010','street_name'=>'Avenida Brigadeiro Faria Lima','street_number'=>'2277','neighborhood'=>'Jardim Paulistano','city'=>'Sao Paulo','federal_unit'=>'SP'],
                ['zip_code'=>'05407002','street_name'=>'Rua Cardeal Arcoverde','street_number'=>'1200','neighborhood'=>'Pinheiros','city'=>'Sao Paulo','federal_unit'=>'SP'],
                ['zip_code'=>'22041001','street_name'=>'Avenida Nossa Senhora de Copacabana','street_number'=>'500','neighborhood'=>'Copacabana','city'=>'Rio de Janeiro','federal_unit'=>'RJ'],
                ...
                ['zip_code'=>'30130010','street_name'=>'Avenida Afonso Pena','street_number'=>'4000','neighborhood'=>'Funcionarios','city'=>'Belo Horizonte','federal_unit'=>'MG'],
